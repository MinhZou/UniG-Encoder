...
def main(args):
    ...
    if args.method in ['AllSetTransformer', 'AllDeepSets']:
        ...
        data = PlainUnigencoder.d_expansion(data, args.threshold, args.norm_type,
                                     args.init_val, args.init_type, args.sample_rate)
        # print(args.threshold, args.norm_type)
    data = data.to(device)
    # Get splits
    split_idx_lst = []
    ...
    elif args.method == 'Unigencoder':
        model = Unigencoder(data.num_features, args.hidden, data.num_classes, args.num_layers, args.dropout)
    else:
    ...
    row = [args.method, args.dname, args.num_layers, args.lr, args.hidden, args.weight_decay, args.dropout,
           args.threshold, args.norm_type, args.init_val, args.init_type, args.sample_rate]
    print(row)
    runtime_list = []
    for run in range(args.runs):
    ...
    row = [args.method, args.dname, args.num_layers, args.lr, args.hidden, args.weight_decay, args.dropout,
           args.threshold, args.norm_type, args.init_val, args.init_type, args.sample_rate, test_mean, test_std]
    with open(args.save_data_dir + "_{}_{}.csv".format(args.dname, str(args.method)), mode="a", newline="") as file:
