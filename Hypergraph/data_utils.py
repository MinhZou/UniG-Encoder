...
#     print(set(idx_features_labels[:, -1]))
    ...
    # print('load features')
    # build graph
    # print(set(idx_features_labels[:, -1].astype(float)))
    # labels_dict = {}
    # print(len(labels))
    # for i in range(len(labels)):
    #     # print(labels[i].item())
    #     if labels[i].item() not in labels_dict:
    #         labels_dict[labels[i].item()] = 0
    #     labels_dict[labels[i].item()] += 1
